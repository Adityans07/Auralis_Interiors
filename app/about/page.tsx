  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-luxury-radial">
        ...
        <div className="container-wide py-20 md:py-28">
          ...
          <Reveal index={1} className="mt-14">
            <div className="relative aspect-[16/8] overflow-hidden rounded-4xl border border-sand-200 shadow-soft">
              <Image
      ...
      <section className="container-wide py-20 md:py-28">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <Reveal index={1} className="order-1 lg:order-2">
            <div className="relative aspect-[4/5] overflow-hidden rounded-4xl border border-sand-200 shadow-soft">
              <Image
      ...
      <section className="container-wide py-10 md:py-16">
        <Reveal className="relative overflow-hidden rounded-4xl bg-ink-950 px-6 py-16 text-center text-sand-50 md:px-16 md:py-24">
          ...
          <div className="relative mx-auto max-w-3xl">
            ...
            <p className="text-2xl font-serif font-medium leading-snug text-sand-50 sm:text-3xl md:text-4xl">
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {TEAM.map((member, i) => (
              <Reveal
                ...
                index={i}
                as="article"
                className="group overflow-hidden rounded-3xl border border-sand-200 bg-white/80 shadow-soft"
              >
      ...
      {/* 7. Trust indicators */}
      <section className="container-wide py-10 md:py-16">
        <Reveal className="rounded-4xl border border-sand-200 bg-white/80 px-6 py-12 shadow-soft md:px-12">
          <dl className="grid grid-cols-2 gap-y-10 text-center lg:grid-cols-4">
            {STATS.map((stat) => (
              <div key={stat.label} className="px-4">
                <dt className="sr-only">{stat.label}</dt>
                <dd>
                  <span className="block font-serif text-4xl font-semibold text-ink-900 sm:text-5xl">
                    {stat.value}
                  </span>
                  <span className="mt-2 block text-sm uppercase tracking-[0.15em] text-ink-500">
                    {stat.label}
                  </span>
                </dd>
              </div>
      ...
      <section className="container-wide py-20 md:py-28">
        <Reveal className="mx-auto max-w-2xl text-center">
          <span className="eyebrow mb-4">Ready when you are</span>
