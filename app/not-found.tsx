...
export default function NotFound() {
  return (
    <div className="container-wide flex min-h-[70vh] flex-col items-center justify-center py-24 text-center">
      <span className="flex h-16 w-16 items-center justify-center rounded-2xl bg-ink-900 text-gold-light">
        <Compass className="h-8 w-8" aria-hidden />
      </span>
      <p className="mt-8 font-serif text-6xl font-semibold text-ink-900">404</p>
